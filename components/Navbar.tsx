      ...
      <div style={{ display: 'flex', alignItems: 'center', padding: '12px 40px', gap: '40px', flexWrap: 'wrap' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center' }}>
          <Link href="/" style={{ display: 'flex', alignItems: 'center', background: 'transparent' }}>
            <Image src="/logo.png" alt="613cards.com Logo" width={200} height={100} className="navbar-logo" style={{ objectFit: 'contain', mixBlendMode: 'lighten', backgroundColor: 'transparent' }} priority />
          </Link>
        </div>
