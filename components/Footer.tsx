...
export function Footer() {
  return (
    <footer style={{ marginTop: 'auto', background: '#0a0118', borderTop: '1px solid var(--glass-border)', padding: '40px 20px', color: 'var(--text-muted)' }}>
      <div style={{ maxWidth: '1200px', margin: '0 auto', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '40px' }}>
        
        <div>
          <h3 style={{ color: 'white', marginBottom: '16px', fontSize: '16px' }}>613cards</h3>
        ...
        <div>
          <h3 style={{ color: 'white', marginBottom: '16px', fontSize: '16px' }}>Shop</h3>
      ...
      <div style={{ maxWidth: '1200px', margin: '40px auto 0 auto', paddingTop: '20px', borderTop: '1px solid rgba(255,255,255,0.05)', textAlign: 'center', fontSize: '12px' }}>
