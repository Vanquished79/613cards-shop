...
export default async function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div style={{ display: 'flex', gap: '24px', paddingTop: '20px', width: '100%' }} className="admin-layout-container">
      <aside className="glass-panel" style={{ width: '250px', padding: '20px', display: 'flex', flexDirection: 'column', gap: '12px', height: 'fit-content', maxHeight: 'calc(100vh - 120px)', overflowY: 'auto', position: 'sticky', top: '100px' }}>
