      ...
      <div style={{ display: 'flex', gap: '16px', borderBottom: '1px solid var(--glass-border)', paddingBottom: '8px' }}>
        <button
          ...
          style={{
            ...
            border: 'none',
            color: activeTab === 'active_submissions' ? 'var(--text-accent)' : 'var(--text-muted)',
            fontWeight: activeTab === 'active_submissions' ? 'bold' : 'normal',
            borderBottom: activeTab === 'active_submissions' ? '2px solid var(--text-accent)' : '2px solid transparent',
            padding: '8px 16px',
            cursor: 'pointer',
            fontSize: '16px',
            transition: 'all 0.2s'
        ...
        <button
          ...
          style={{
            background: 'transparent',
            border: 'none',
            color: activeTab === 'archived_submissions' ? 'var(--text-accent)' : 'var(--text-muted)',
            fontWeight: activeTab === 'archived_submissions' ? 'bold' : 'normal',
            borderBottom: activeTab === 'archived_submissions' ? '2px solid var(--text-accent)' : '2px solid transparent',
            padding: '8px 16px',
            cursor: 'pointer',
            fontSize: '16px',
            transition: 'all 0.2s'
        ...
        <button
          ...
          style={{
            background: 'transparent',
            border: 'none',
            color: activeTab === 'wanted' ? 'var(--text-accent)' : 'var(--text-muted)',
            fontWeight: activeTab === 'wanted' ? 'bold' : 'normal',
            borderBottom: activeTab === 'wanted' ? '2px solid var(--text-accent)' : '2px solid transparent',
            padding: '8px 16px',
            cursor: 'pointer',
            fontSize: '16px',
            transition: 'all 0.2s'
