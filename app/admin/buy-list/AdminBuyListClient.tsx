...
export default function AdminBuyListClient({ 
  ...
  const [activeTab, setActiveTab] = useState<'submissions' | 'wanted'>('submissions');
      ...
      <div style={{ display: 'flex', gap: '16px', borderBottom: '1px solid var(--glass-border)', paddingBottom: '8px' }}>
        <button
          ...
          style={{
            ...
            border: 'none',
            color: activeTab === 'submissions' ? 'var(--accent-color)' : 'var(--text-muted)',
            fontWeight: activeTab === 'submissions' ? 'bold' : 'normal',
            borderBottom: activeTab === 'submissions' ? '2px solid var(--accent-color)' : '2px solid transparent',
            padding: '8px 16px',
            cursor: 'pointer',
            fontSize: '16px',
            transition: 'all 0.2s'
        ...
        >
          Sell Submissions ({submissions.length})
        </button>
        <button
