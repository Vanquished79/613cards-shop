    ...
    if (process.env.RESEND_API_KEY) {
      ...
      try {
        const { error: emailError } = await resend.emails.send({
          ...
          html: `
            <div style="font-family: 'Inter', Arial, sans-serif; background-image: linear-gradient(to bottom, #0a0118, #0a0118); padding: 40px 20px; color: #ffffff; text-align: center; -webkit-text-fill-color: #ffffff;">
              <div style="max-width: 600px; margin: 0 auto; background-image: linear-gradient(to bottom, #1a0b2e, #1a0b2e); border: 1px solid #302048; border-radius: 16px; padding: 40px 30px; box-shadow: 0 4px 20px rgba(0,0,0,0.5);">
                <img src="https://613cards.online${logoImg.src}" alt="613cards.online Logo" style="width: 200px; margin-bottom: 20px;" />
                
                <h1 style="color: #ffb703; font-size: 28px; margin-top: 0; -webkit-text-fill-color: #ffb703;">You're on the list!</h1>
                ...
                <p style="font-size: 16px; color: #a1a1aa; line-height: 1.6; text-align: left; -webkit-text-fill-color: #a1a1aa;">
                  Thanks for joining the waitlist for <strong style="color: #ffffff; -webkit-text-fill-color: #ffffff;">613cards.online</strong>! We are working hard behind the scenes to bring you the ultimate trading card shop.
                </p>
                <p style="font-size: 16px; color: #a1a1aa; line-height: 1.6; text-align: left; -webkit-text-fill-color: #a1a1aa;">
                ...
                <div style="margin-top: 30px; padding-top: 20px; border-top: 1px solid #302048; text-align: left;">
                  <p style="font-size: 14px; color: #ffb703; margin: 0; -webkit-text-fill-color: #ffb703;"><strong>The 613cards Team</strong></p>
                </div>
              </div>
            </div>
          `
