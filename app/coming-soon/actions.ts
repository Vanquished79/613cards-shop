            ...
            <div style="font-family: 'Inter', Arial, sans-serif; background-image: linear-gradient(to bottom, #0a0118, #0a0118); padding: 40px 20px; color: #ffffff; text-align: center; -webkit-text-fill-color: #ffffff;">
              <div style="max-width: 600px; margin: 0 auto; background-image: linear-gradient(to bottom, #1a0b2e, #1a0b2e); border: 1px solid #302048; border-radius: 16px; padding: 40px 30px; box-shadow: 0 4px 20px rgba(0,0,0,0.5);">
                ...
                <p style="font-size: 16px; color: #a1a1aa; line-height: 1.6; text-align: left; -webkit-text-fill-color: #a1a1aa;">
                  Thanks for joining the waitlist for <strong style="color: #ffffff; -webkit-text-fill-color: #ffffff;">613cards</strong>! We are working hard behind the scenes to bring you the ultimate trading card shop.
                </p>
                <p style="font-size: 16px; color: #a1a1aa; line-height: 1.6; text-align: left; -webkit-text-fill-color: #a1a1aa;">
