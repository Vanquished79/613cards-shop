    ...
    <div style={{ maxWidth: '800px', margin: '40px auto', padding: '0 20px', lineHeight: '1.6' }}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
        <div className="glass-panel" style={{ padding: '24px' }}>
          <h2 style={{ color: 'var(--accent-color)', marginBottom: '12px' }}>How do you ship your cards?</h2>
        ...
        <div className="glass-panel" style={{ padding: '24px' }}>
          <h2 style={{ color: 'var(--accent-color)', marginBottom: '12px' }}>Do you buy cards?</h2>
          <p style={{ color: 'var(--text-muted)' }}>
            Yes! We buy singles, sealed products, and collections. Check out our <Link href="/buy-list" style={{ color: 'var(--accent-color)' }}>Buy-List</Link> page for our current rates and instructions on how to submit your cards.
          </p>
        </div>

        <div className="glass-panel" style={{ padding: '24px' }}>
          <h2 style={{ color: 'var(--accent-color)', marginBottom: '12px' }}>When will my order ship?</h2>
          <p style={{ color: 'var(--text-muted)' }}>
        ...
        <div className="glass-panel" style={{ padding: '24px' }}>
          <h2 style={{ color: 'var(--accent-color)', marginBottom: '12px' }}>Do you ship internationally?</h2>
          <p style={{ color: 'var(--text-muted)' }}>
