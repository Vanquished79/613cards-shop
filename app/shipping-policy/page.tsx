  ...
  return (
    <div style={{ maxWidth: '800px', margin: '40px auto', padding: '0 20px', lineHeight: '1.6' }}>
      ...
      <div className="glass-panel" style={{ padding: '32px' }}>
        <h2 style={{ color: 'var(--text-accent)', marginBottom: '16px' }}>Domestic Shipping (Canada & USA)</h2>
        ...
        <h2 style={{ color: 'var(--text-accent)', marginBottom: '16px' }}>International Shipping</h2>
        ...
        <h2 style={{ color: 'var(--text-accent)', marginBottom: '16px' }}>Packaging Standards</h2>
        <p style={{ color: 'var(--text-muted)', marginBottom: '24px' }}>
        ...
        <h2 style={{ color: 'var(--text-accent)', marginBottom: '16px' }}>Lost or Damaged Packages</h2>
        <p style={{ color: 'var(--text-muted)' }}>
          If your package is lost in transit or arrives damaged, please <Link href="/contact" style={{ color: 'var(--text-accent)' }}>contact us</Link> immediately. Please keep all original packaging materials as they may be required for insurance claims.
        </p>
      </div>
    </div>
  );
